...
public class Day22 {
  ...
  private static class Spell {
    ...
    public Spell(String n, int m, int d, int h, int a, Effect e) {
      name = n;
      manaCost = m;
      damage = d;
      heals = h;
  ...
  public static class Effect {
    ...
    public Effect(int t, int d, int m, int a) {
      turns = t;
      damage = d;
      manna = m;
      armor = a;
  ...
  static {
    SPELLS.add(new Spell("MagicMissile", 53, 4, 0, 0, null));

    SPELLS.add(new Spell("Drain", 73, 2, 2, 0, null));

    Effect effect = new Effect(6, 0, 0, 7);
    SPELLS.add(new Spell("Shield", 113, 0, 0, 0, effect));

    effect = new Effect(6, 3, 0, 0);
    SPELLS.add(new Spell("Poison", 173, 0, 0, 0, effect));

    effect = new Effect(5, 0, 101, 0);
    SPELLS.add(new Spell("Recharge", 229, 0, 0, 0, effect));
  }
  ...
  public static class Me {
    ...
    public Me(int hp, int m) {
      hitPoints = hp;
      manna = m;
    }

    public Me(Me me) {
      hitPoints = me.hitPoints;
      manna = me.manna;
    }
    ...
    public boolean hasManna() {
      return manna > 0;
    }
  }

  public static class Battle {
    public Me me = new Me(50, 500);
    public Boss boss = new Boss(55, 8);
    public boolean isNotOver() {
      return me.isAlive() && boss.isAlive() && me.hasManna();
    }
    public int cost() {
      return 500 - me.manna;
    }
